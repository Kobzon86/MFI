	qsys_common u0 (
		...
		.discr_cmd_in_export                (<connected-to-discr_cmd_in_export>),                //                   .export
		...
		.pu_backlight_fault                 (<connected-to-pu_backlight_fault>),                 //                   .fault
		.pu_i2c_clk                         (<connected-to-pu_i2c_clk>),                         //             pu_i2c.clk
		.pu_i2c_data                        (<connected-to-pu_i2c_data>),                        //                   .data
		.pu_type_ext                        (<connected-to-pu_type_ext>),                        //            pu_type.ext
