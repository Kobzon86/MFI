...
$(MEM_0)_HIERARCHICAL_PATH := nios_ram_0
$(MEM_0)_WIDTH := 32
...
.PHONY: nios_ram_0
nios_ram_0: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: shared_ram_0
MEM_1 := qsys_shared_ram_0
$(MEM_1)_NAME := shared_ram_0
...
$(MEM_1)_END := 0x000001ff
$(MEM_1)_SPAN := 0x00000200
$(MEM_1)_HIERARCHICAL_PATH := shared_ram_0
$(MEM_1)_WIDTH := 32
...
.PHONY: shared_ram_0
shared_ram_0: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
